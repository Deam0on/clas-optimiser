...
# import datasets
os.system("gsutil -m cp gs://uw-nn-storage_v2/Dataset/DATASET_T2.csv /home/deamoon_uw_nn/bucket_source")
os.system("gsutil -m cp gs://uw-nn-storage_v2/Dataset/DATASET_V2.csv /home/deamoon_uw_nn/bucket_source")
...
os.system("gsutil -m cp -r /home/deamoon_uw_nn/bucket_source gs://uw-nn-storage_v2/Results")
...
os.system("gsutil -m cp -r "+ new_run +" gs://uw-nn-storage_v2/Archive")
